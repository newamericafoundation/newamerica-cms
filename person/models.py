...
class Person(Page):
    ...
    content_panels = Page.content_panels + [
        ...
        MultiFieldPanel([
            PageChooserPanel(
                'feature_work_1',
                ['article.Article', 'blog.BlogPost', 'book.Book', 'event.Event', 'issue.IssueOrTopic', 'podcast.Podcast', 'policy_paper.PolicyPaper', 'press_release.PressRelease', 'quoted.Quoted', 'weekly.WeeklyArticle', 'thread.ThreadArticle', 'report.Report', 'in_depth.InDepthProject', 'other_content.OtherPost']),
            PageChooserPanel(
                'feature_work_2',
                ['article.Article', 'blog.BlogPost', 'book.Book', 'event.Event', 'issue.IssueOrTopic', 'podcast.Podcast', 'policy_paper.PolicyPaper', 'press_release.PressRelease', 'quoted.Quoted', 'weekly.WeeklyArticle', 'thread.ThreadArticle', 'report.Report', 'in_depth.InDepthProject', 'other_content.OtherPost']),
            PageChooserPanel(
