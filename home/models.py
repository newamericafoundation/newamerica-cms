...
class Post(Page):
    ...
    story_excerpt = models.CharField(blank=True, null=True, max_length=140, help_text="140 character limit. If not 'Search Description' is defined, this populates the post summary that shows up on search results on newamerica.org and is indexed by google")
