    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recent_carousel', wagtail.wagtailcore.fields.StreamField([('event', wagtail.wagtailcore.blocks.PageChooserBlock()), ('policy_paper', wagtail.wagtailcore.blocks.PageChooserBlock())], blank=True)),
            ],
            options={
                'abstract': False,
            },
