    ...
    content_panels = ProgramSimplePage.content_panels + [
        MultiFieldPanel([
            PageChooserPanel(
                ...
                ['article.Article', 'blog.BlogPost', 'book.Book', 'brief.Brief', 'event.Event', 'issue.IssueOrTopic', 'podcast.Podcast', 'policy_paper.PolicyPaper', 'press_release.PressRelease', 'quoted.Quoted', 'weekly.WeeklyArticle', 'the_thread.ThreadArticle', 'report.Report', 'in_depth.InDepthProject', 'other_content.OtherPost']),
            PageChooserPanel(
