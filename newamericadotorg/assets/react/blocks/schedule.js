...
class Session extends Component {
  ...
  render() {
    ...
    return (
      <div
        className={`schedule-block__sessions__session ${
          expanded && hasDesc ? 'expanded' : ''
        }`}
      >
        <div className="schedule-block__sessions__session__heading">
          <div
            className="schedule-block__sessions__session__heading__title"
            onClick={expand}
          >
            <h5>
              ...
              <div className="schedule-block__sessions__session__speakers">
                {speakers.map((s, i) => (
                  <div className="schedule-block__sessions__session__speakers__speaker margin-bottom-25">
                    ...
                    {s.title && (
                      <h6 className="caption margin-10">{s.title}</h6>
                    )}
                  </div>
                ))}
              </div>
