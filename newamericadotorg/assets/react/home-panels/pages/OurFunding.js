    ...
    return(
      <div class="our-funding-main" ref={(el)=>{ this.el = el; }}>
        <Body data={how_were_funded} aside={<div className="buttons">
          <div className="charity-navigator-img margin-bottom-25 charity-seals" style={{textAlign: 'center'}}>
            ...
            <a class="charity-img charity-lg" href="https://app.candid.org/profile/7781756" target="_blank"> 
              <img src="https://widgets.guidestar.org/prod/v1/pdp/transparency-seal/7781756/svg" />
            </a>
            <a class="charity-img charity-lg" href="https://www.charitynavigator.org/ein/522096845" target="_blank"> 
        ...
        <div className="funding-table container--1080">
          ...
          <HorizontalNav className={`our-funding__nav our-funding__nav--chart-tabs`} items={[
            ...
            { url: '/our-funding/2020/', label: '2020'},
          ...
          <div className="dataviz__chart-container">
            <Switch>
              ...
              <Route exact path="/our-funding/2020/" render={(props)=>(
                <iframe title="Active Funding in Q4 2020" aria-label="Table" id="datawrapper-chart-T11iH" src="//datawrapper.dwcdn.net/T11iH/"  scrolling="no" frameborder="0" width="100%" height="650"></iframe>
              )}/>
              <Route exact path="/our-funding/2021/" render={(props)=>(
                <iframe title="Active Funding in Q4 2021" aria-label="Table" id="datawrapper-chart-1zMjd" src="//datawrapper.dwcdn.net/1zMjd/"  scrolling="no" frameborder="0" width="100%" height="650"></iframe>
              )}/>
              <Route exact path="/our-funding/2022/" render={(props)=>(
                <iframe title="Active Funding in Q4 2022" aria-label="Table" id="datawrapper-chart-faFek" src="//datawrapper.dwcdn.net/faFek/"  scrolling="no" frameborder="0" width="100%" height="650"></iframe>
              )}/>
