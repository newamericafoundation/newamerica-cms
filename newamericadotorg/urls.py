...
urlpatterns = [
    ...
    url(r'^api/author/$', cache_page(60 * 10)(api_views.AuthorList.as_view()), name='author_list'),
    url(r'^api/fellow/$', cache_page(60 * 10)(api_views.FellowList.as_view()), name='fellow_list'),
    ...
    url(r'^api/subprogram/(?P<pk>[\d]+)/$', cache_page(60 * 1440)(api_views.SubprogramDetail.as_view()), name='subprogram_page'),
    url(r'^api/weekly/$', cache_page(60 * 5040)(api_views.WeeklyList.as_view()), name='weekly_list'),
    url(r'^api/weekly/(?P<pk>[\d]+)/$', cache_page(60 * 5040)(api_views.WeeklyDetail.as_view()), name='weekly'),
