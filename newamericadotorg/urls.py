...
urlpatterns = [
    ...
    url(r'^api/author/$', cache_page(60 * 10, key_prefix='author_list')(api_views.AuthorList.as_view())),
    url(r'^api/fellow/$', cache_page(60 * 10, key_prefix='fellow_list')(api_views.FellowList.as_view())),
    url(r'^api/program/(?P<pk>[\d]+)/$', cache_page(60 * 1440, key_prefix='program_page')(api_views.ProgramDetail.as_view())),
    url(r'^api/program/$', cache_page(60 * 1440, key_prefix='program_list')(api_views.ProgramList.as_view())),
    ...
    url(r'^api/subprogram/(?P<pk>[\d]+)/$', cache_page(60 * 1440, key_prefix='subprogram_page')(api_views.SubprogramDetail.as_view())),
    url(r'^api/weekly/$', cache_page(60 * 5040, key_prefix='weekly_list')(api_views.WeeklyList.as_view())),
    url(r'^api/weekly/(?P<pk>[\d]+)/$', cache_page(60 * 5040, key_prefix='weekly_page')(api_views.WeeklyDetail.as_view())),
    url(r'^api/report/(?P<pk>[\d]+)/$', cache_page(60 * 1440, key_prefix='report')(api_views.ReportDetail.as_view())),
