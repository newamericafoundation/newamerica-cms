...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            field=wagtail.fields.StreamField((('page', wagtail.blocks.PageChooserBlock()),), blank=True, null=True),
        ),
        migrations.AlterField(
            model_name='program',
            name='sidebar_menu_about_us_pages',
            field=wagtail.fields.StreamField((('Item', wagtail.blocks.PageChooserBlock()),), blank=True, null=True),
        ),
        migrations.AlterField(
            model_name='program',
